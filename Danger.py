...
TOKEN = '7762752327:AAHZsevXgs0lN-bzz8ThVDTZJ1KKUvlcMHw,
MONGO_URI = 'mongodb+srv://Cluster0:Cluster0@cluster0.5mvg9ej.mongodb.net/danger?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID = -1002905557849
CHANNEL_ID = -1002905557849
error_channel_id = -1002905557849
...
bot = telebot.TeleBot(7762752327:AAHZsevXgs0lN-bzz8ThVDTZJ1KKUvlcMHw)
REQUEST_INTERVAL = 1
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @Angad_Apk_DDOS.*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @Angad_Apk_DDOS* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @Angad_Apk_DDOS* 🙏"  # Contact owner message
    else:
